...
void Scene::render() {
	...
	//objects
	Sphere sphere = Sphere(Vector(0.0f, 0.0f, -5.0f), 1.0f, &mat1); raytracer.list_primitives.push_back(&sphere);
	Sphere sphere2 = Sphere(Vector(1.0f, 1.0f, -1.2f), 0.3f, &mat1); raytracer.list_primitives.push_back(&sphere2);
	Sphere sphere3 = Sphere(Vector(-0.5f, 0.3f, -1.1f), 0.5f, &mat2); raytracer.list_primitives.push_back(&sphere3);
	Triangle triangle1 = Triangle(Vector(1.0f, -1.0f, -3.0f), Vector(-1.0f, -1.0f, -3.0f), Vector(1.0f, 1.0f, -3.0f), &mat2); raytracer.list_primitives.push_back(&triangle1);
...
int main() {
	Scene scene = Scene(Vector(0.0f, 0.0f, 0.0f), 300, 300);
	scene.render();
